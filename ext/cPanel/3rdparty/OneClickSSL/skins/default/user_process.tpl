...
$(document).ready(function(){
    ...
    $.get('order.live.php?d={{ domain }}&v={{ voucher }}&o={{ email }}&r={{ revoke }}', function(data) {
    ...
    var imgBusy  = 'images/loading.gif';
    var imgDone  = 'images/checkmark.png';
    var imgError = 'images/errormark.png';
	...
	function getStatus() {
        $.getJSON('status.live.php?d={{ domain }}', function(data) {
    ...
    var t=setTimeout(getStatus,200);
});
</script>
<style type="text/css">
{% include "style.css" %}
